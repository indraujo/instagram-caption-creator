...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">catatan</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Input catatan</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="<?php echo base_url();?>catatan/input_catatan" method="POST">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Edit catatan</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="<?php echo base_url("catatan/update");?>" method="POST">
							
								<div class="form-group">
									<label>Edit catatan</label>
									<?php foreach($catatan as $h){?>
									<input type="hidden" name="id_catatan" value="<?php echo $h->id_catatan;?>"/>
									<textarea class="form-control" rows="3" name="catatan" ><?php echo $h->catatan;?></textarea>
									<?php }?>
								</div>
								<input type="submit" class="btn btn-primary"></button>
							</form>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table"  >
						    <thead>
						    <tr align="center">
						        <th data-align="center">ID catatan</th>
						        <th data-align="center">catatan</th>
						        <th data-align="center">Action</th>
						    </tr>
						    </thead>
						    <?php foreach($catatan as $a){ 
						    	$id_catatan = $a->id_catatan;?>
						    <tr >
						        <td ><?php echo $id_catatan; ?></td>
						        <td ><?php echo $a->catatan; ?></td>
						        <td >
						        		<a href="<?php echo base_url("catatan/edit?id_catatan=".$id_catatan);?>"><button type="submit" class="btn btn-primary">Edit</button></a>
										<a href="<?php echo base_url("catatan/delete?id_catatan=".$id_catatan);?>"><button type="reset" class="btn btn-default">Delete</button></a>
								</td>
						    </tr>
						    <?php } ?>
						</table>
