...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Input garansi</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="<?php echo base_url();?>garansi/input_garansi" method="POST">
							
								<div class="form-group">
									<label>garansi</label>
									<textarea class="form-control" rows="3" name="garansi"></textarea>
								</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Edit garansi</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="<?php echo base_url("garansi/update");?>" method="POST">
							
								<div class="form-group">
									<label>Edit garansi</label>
									<?php foreach($garansi as $h){?>
									<input type="hidden" name="id_garansi" value="<?php echo $h->id_garansi;?>"/>
									<textarea class="form-control" rows="3" name="garansi" ><?php echo $h->garansi;?></textarea>
									<?php }?>
								</div>
								<input type="submit" class="btn btn-primary"></button>
							</form>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table"  >
						    <thead>
						    <tr align="center">
						        <th data-align="center">ID garansi</th>
						        <th data-align="center">garansi</th>
						        <th data-align="center">Action</th>
						    </tr>
						    </thead>
						    <?php foreach($garansi as $a){ 
						    	$id_garansi = $a->id_garansi;?>
						    <tr >
						        <td ><?php echo $id_garansi; ?></td>
						        <td ><?php echo $a->garansi; ?></td>
						        <td >
						        		<a href="<?php echo base_url("garansi/edit?id_garansi=".$id_garansi);?>"><button type="submit" class="btn btn-primary">Edit</button></a>
										<a href="<?php echo base_url("garansi/delete?id_garansi=".$id_garansi);?>"><button type="reset" class="btn btn-default">Delete</button></a>
								</td>
						    </tr>
						    <?php } ?>
						</table>
