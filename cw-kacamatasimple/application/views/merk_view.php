		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Input merk</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="<?php echo base_url();?>merk/input_merk" method="POST">
							
								<div class="form-group">
									<label>Merk</label>
									Nama Merk 	:<textarea class="form-control" rows="3" name="merk"></textarea>
									Kode 		:<textarea class="form-control" rows="3" name="kode_merk"></textarea>
								</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="<?php echo base_url("merk/update");?>" method="POST">
							
								<div class="form-group">
									<label>Edit merk</label>
									<?php foreach($merk as $h){?>
									<input type="hidden" name="id_merk" value="<?php echo $h->id_merk;?>"/>
									Nama Merk :<textarea class="form-control" rows="3" name="merk" ><?php echo $h->merk;?></textarea>
									Kode Merk : <textarea class="form-control" rows="3" name="kode_merk" ><?php echo $h->kode_merk;?></textarea>
									<?php }?>
								</div>
								<input type="submit" class="btn btn-primary"></button>
							</form>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table"  >
						    <thead>
						    <tr align="center">
						        <th data-align="center">ID merk</th>
						        <th data-align="center">Merk</th>
						        <th data-align="center">Kode Merk</th>
						    ...
						    <tr >
						        ...
						        <td ><?php echo $a->kode_merk; ?></td>
						        <td >
						        		<a href="<?php echo base_url("merk/edit?id_merk=".$id_merk);?>"><button type="submit" class="btn btn-primary">Edit</button></a>
										<a href="<?php echo base_url("merk/delete?id_merk=".$id_merk);?>"><button type="reset" class="btn btn-default">Delete</button></a>
								</td>
						    </tr>
						    <?php } ?>
						</table>
