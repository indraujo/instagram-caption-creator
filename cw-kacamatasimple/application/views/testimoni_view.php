		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Input testimoni</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="<?php echo base_url();?>testimoni/input_testimoni" method="POST">
							
								<div class="form-group">
									<label>testimoni</label>
									<textarea class="form-control" rows="3" name="testimoni"></textarea>
								</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="<?php echo base_url("testimoni/update");?>" method="POST">
							
								<div class="form-group">
									<label>Edit testimoni</label>
									<?php foreach($testimoni as $h){?>
									<input type="hidden" name="id_testimoni" value="<?php echo $h->id_testimoni;?>"/>
									<textarea class="form-control" rows="3" name="testimoni" ><?php echo $h->testimoni;?></textarea>
									<?php }?>
								</div>
								<input type="submit" class="btn btn-primary"></button>
							</form>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table"  >
						    <thead>
						    <tr align="center">
						        <th data-align="center">ID testimoni</th>
						        <th data-align="center">testimoni</th>
						        <th data-align="center">Action</th>
						    </tr>
						    </thead>
						    <?php foreach($testimoni as $h){ 
						    	$id_testimoni = $h->id_testimoni;?>
						    <tr >
						        <td ><?php echo $id_testimoni; ?></td>
						        <td ><?php echo $h->testimoni; ?></td>
						        <td >
						        		<a href="<?php echo base_url("testimoni/edit?id_testimoni=".$id_testimoni);?>"><button type="submit" class="btn btn-primary">Edit</button></a>
										<a href="<?php echo base_url("testimoni/delete?id_testimoni=".$id_testimoni);?>"><button type="reset" class="btn btn-default">Delete</button></a>
								</td>
						    </tr>
						    <?php } ?>
						</table>
