		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Input bonus</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="<?php echo base_url();?>bonus/input_bonus" method="POST">
							
								<div class="form-group">
									<label>bonus</label>
									<textarea class="form-control" rows="3" name="bonus"></textarea>
								</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="<?php echo base_url("bonus/update");?>" method="POST">
							
								<div class="form-group">
									<label>Edit bonus</label>
									<?php foreach($bonus as $h){?>
									<input type="hidden" name="id_bonus" value="<?php echo $h->id_bonus;?>"/>
									<textarea class="form-control" rows="3" name="bonus" ><?php echo $h->bonus;?></textarea>
									<?php }?>
								</div>
								<input type="submit" class="btn btn-primary"></button>
							</form>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table"  >
						    <thead>
						    <tr align="center">
						        <th data-align="center">ID bonus</th>
						        <th data-align="center">bonus</th>
						        <th data-align="center">Action</th>
						    </tr>
						    </thead>
						    <?php foreach($bonus as $a){ 
						    	$id_bonus = $a->id_bonus;?>
						    <tr >
						        <td ><?php echo $id_bonus; ?></td>
						        <td ><?php echo $a->bonus; ?></td>
						        <td >
						        		<a href="<?php echo base_url("bonus/edit?id_bonus=".$id_bonus);?>"><button type="submit" class="btn btn-primary">Edit</button></a>
										<a href="<?php echo base_url("bonus/delete?id_bonus=".$id_bonus);?>"><button type="reset" class="btn btn-default">Delete</button></a>
								</td>
						    </tr>
						    <?php } ?>
						</table>
